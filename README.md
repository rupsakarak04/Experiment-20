...
AIM
To perform a complete Exploratory Data Analysis (EDA) on a global Covid-19 dataset to identify patterns, clean structural inconsistencies, and extract localized statistical insights using Python.
